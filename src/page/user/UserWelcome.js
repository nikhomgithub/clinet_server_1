...
function UserWelcome() {
  ...
  const submitAddUser=(formInputState)=>{
    axios.post(`/fpuser/adduser`,formInputState,myheader)
    .then(result=>{
  ...
  const submitChangePassword=(formInputState)=>{
    axios.post(`/fpuser/changepassword`,formInputState,myheader)
    .then(result=>{
  ...
  const submitLogIn=(formInputState)=>{
    axios.post(`/fpuser/login`,formInputState,myheader)
    .then(result=>{
